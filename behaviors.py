...
MAGIC_TRIGGERS = {
    ...
    (
        ...
        MACRO_DBL,
        MACRO_GRV,
    ): KC.MACRO(Tap(KC.RIGHT), Tap(KC.SPC)),
    ...
    Seq(KC.D, KC.E, KC.F): KC.MACRO(Tap(KC.ENT), "return "),
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # WORKFLOW: The "Togle speach reckognition on/off"
    # ------------------------------------------------------------------------
    KC.LCTL(KC.LSFT(KC.I)): KC.LCTL(KC.LSFT(KC.I)),
    KC.LCTL(KC.LSFT(KC.U)): KC.LCTL(KC.LSFT(KC.U)),
}

# Initialize the module
magic_key_mod = MagicKey(
    magic_key=MAGIC, triggers=MAGIC_TRIGGERS, default_behavior=MAGIC_DEFAULT
)
