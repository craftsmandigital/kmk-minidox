...
LAYERS = [
    # LAYER 0: BASE
        ...
        XXXX,    XXXX,    NAV_HT,  KC.SPC,  SYM_SK,     KC.ENT,  MAGIC,    NUM_SK,   XXXX,   XXXX,
    ],
    # LAYER 1: SYM
    [
        ...
        XXXX,    XXXX,    US_CIRC, KC.AT,   KC.BSLS,     KC.AMPR, XXXX,    XXXX,    XXXX,    XXXX,
    ],
    # LAYER 2: NUM
    [
        ...
        XXXX,    XXXX,    KC.N0,   KC.SPC,  KC.CW,       KC.CAPS, XXXX,    FUN_SK,  XXXX,    XXXX,
    ],
    ...
    # LAYER 4: NAV
    [
        XXXX,    SelAll,  KC.PGUP, KC.PGDN, XXXX,        KC.HOME, KC.TAB,  ALT_TAB_X, KC.END,  Redo,
        OS_LGUI, OS_LALT, OS_LCTL, OS_LSFT, PasteM,      KC.LEFT, KC.DOWN, KC.UP,     KC.RGHT, Undo,
        XXXX,    Cut,     Copy,    PasteU,  Paste,       WordL,   KC.BSPC, KC.DEL,    WordR,   RClick,
        XXXX,    XXXX,    TRNS ,   TRNS,    XXXX,        SFT_ENT, XXXX,    XXXX,      XXXX,    XXXX,
    ]
]
