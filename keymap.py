...
LAYERS = [
    ...
    [
        ...
        KC.MINS, KC.QUES, KC.COLN, US_DQUO, KC.SLSH,     KC.DOT,  OS_LCTL, OS_LSFT, OS_LALT, OS_LGUI,
    ...
    [
        ...
        XXXX,    KC.F4,   KC.F5,   KC.F6,   XXXX,        XXXX,    OS_LCTL, OS_LSFT, OS_LALT, OS_LGUI,
        XXXX,    KC.F1,   KC.F2,   KC.F3,   XXXX,        XXXX,    XXXX,    XXXX,    XXXX,    XXXX,
